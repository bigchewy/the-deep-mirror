...
export const metadata: Metadata = {
  ...
  description: `Conversational AI Enneagram typing that gets sharper over time. For executives and coaches who need deeper insights than survey-based tools provide.`,
};
